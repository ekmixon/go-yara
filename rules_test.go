...
func (c *testCallback) RuleMatching(ctx *ScanContext, r *Rule) (bool, error) {
	c.t.Logf("RuleMatching callback called: rule=%s", r.Identifier())
	c.matched[r.Identifier()] = struct{}{}
	return false, nil
}
func (c *testCallback) RuleNotMatching(ctx *ScanContext, r *Rule) (bool, error) {
...
func (c *testCallback) ImportModule(ctx *ScanContext, s string) ([]byte, bool, error) {
